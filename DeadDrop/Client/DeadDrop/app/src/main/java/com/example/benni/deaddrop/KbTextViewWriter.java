...
public class KbTextViewWriter implements KnowledgeBaseListener {
    ...
    public static final int LOG_CON = 0;
    public static final int LOG_KB = 1;
    ...
    public void topicAdded(SemanticTag semanticTag) {
        try {
            appendToKbText("Semantic Tag added: " + L.semanticTag2String(semanticTag));
    ...
    public void peerAdded(PeerSemanticTag peerSemanticTag) {
        try {
            appendToKbText("Peer Semantic Tag added: " + L.semanticTag2String(peerSemanticTag));
        } catch (SharkKBException e) {
            L.d("Internal", "Error while writing Tag to text view: " + e.toString());
        }    }
    ...
    public void locationAdded(SpatialSemanticTag spatialSemanticTag) {
        try {
            appendToKbText("Spatial Semantic Tag added: " + L.semanticTag2String(spatialSemanticTag));
        } catch (SharkKBException e) {
            L.d("Internal", "Error while writing Tag to text view: " + e.toString());
        }    }
    ...
    public void timespanAdded(TimeSemanticTag timeSemanticTag) {
        try {
            appendToKbText("Time Semantic Tag added: " + L.semanticTag2String(timeSemanticTag));
        } catch (SharkKBException e) {
            L.d("Internal", "Error while writing Tag to text view: " + e.toString());
        }    }
    ...
    public void topicRemoved(SemanticTag semanticTag) {
        try {
            appendToKbText("Semantic Tag removed: " + L.semanticTag2String(semanticTag));
        } catch (SharkKBException e) {
            L.d("Internal", "Error while writing Tag to text view: " + e.toString());
        }    }
    ...
    public void peerRemoved(PeerSemanticTag peerSemanticTag) {
        try {
            appendToKbText("Peer Semantic Tag removed: " + L.semanticTag2String(peerSemanticTag));
        } catch (SharkKBException e) {
            L.d("Internal", "Error while writing Tag to text view: " + e.toString());
        }
    }
    ...
    public void locationRemoved(SpatialSemanticTag spatialSemanticTag) {
        try {
            appendToKbText("Spatial Semantic Tag removed: " + L.semanticTag2String(spatialSemanticTag));
        } catch (SharkKBException e) {
            L.d("Internal", "Error while writing Tag to text view: " + e.toString());
        }
    }
    ...
    public void timespanRemoved(TimeSemanticTag timeSemanticTag) {
        try {
            appendToKbText("Time Semantic Tag removed: " + L.semanticTag2String(timeSemanticTag));
        } catch (SharkKBException e) {
            L.d("Internal", "Error while writing Tag to text view: " + e.toString());
        }
    }
    ...
    public void contextPointAdded(ContextPoint contextPoint) {
        appendToKbText("Context Point added: " + L.cp2String(contextPoint));
    }

    @Override
    public void cpChanged(ContextPoint contextPoint) {
        appendToKbText("Context Point changed: " + L.cp2String(contextPoint));
    }

    @Override
    public void contextPointRemoved(ContextPoint contextPoint) {
        appendToKbText("Context Point removed: " + L.cp2String(contextPoint));
    }
}
